...
tar -xf PyQt5_sip-12.8.1.tar.gz
...
tar -xf PyQt5-5.15.2.dev2011131516.tar.gz
...
../pyodide/cpython/build/3.8.2/host/bin/python3 ./configure.py --qmake ../qt5/qtbase/bin/qmake --static --confirm-license
